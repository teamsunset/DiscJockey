...
public class ModelDDJ400<T extends Entity> extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition left_cue_button = left_button.addOrReplaceChild("left_cue_button", CubeListBuilder.create().texOffs(0, 87).addBox(-17.15F, -3.85F, 3.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-1.75F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition left_play_button = left_button.addOrReplaceChild("left_play_button", CubeListBuilder.create().texOffs(0, 66).addBox(-17.15F, -3.85F, 2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-1.75F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition right_disc = right.addOrReplaceChild("right_disc", CubeListBuilder.create().texOffs(92, 34).addBox(-7.625F, -5.95F, 3.875F, 9.0F, 8.25F, 9.0F, new CubeDeformation(-3.375F))
                ...
                .texOffs(66, 54).addBox(-7.125F, -5.95F, 6.375F, 8.0F, 8.25F, 7.0F, new CubeDeformation(-3.375F))
                .texOffs(96, 87).mirror().addBox(-7.625F, -5.95F, 3.625F, 9.0F, 8.25F, 7.0F, new CubeDeformation(-3.375F)).mirror(false)
                .texOffs(98, 71).mirror().addBox(-7.125F, -5.95F, 3.375F, 8.0F, 8.25F, 7.0F, new CubeDeformation(-3.375F)).mirror(false), PartPose.offset(8.25F, -0.025F, -7.875F));
        ...
        PartDefinition right_cue_button = right_button.addOrReplaceChild("right_cue_button", CubeListBuilder.create().texOffs(0, 87).addBox(-7.25F, -3.85F, 3.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-1.75F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition right_play_button = right_button.addOrReplaceChild("right_play_button", CubeListBuilder.create().texOffs(0, 66).addBox(-7.25F, -3.85F, 2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-1.75F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition right_bpm_fader = right.addOrReplaceChild("right_bpm_fader", CubeListBuilder.create().texOffs(54, 59).addBox(-2.125F, -3.5F, 4.375F, 3.0F, 2.75F, 2.5F, new CubeDeformation(-1.125F))
                ...
                .texOffs(44, 56).addBox(-2.125F, -3.275F, 4.625F, 3.0F, 2.5F, 2.5F, new CubeDeformation(-1.125F)), PartPose.offset(7.75F, 0.0F, -8.625F));
        ...
        PartDefinition middle_fader = middle.addOrReplaceChild("middle_fader", CubeListBuilder.create(), PartPose.offset(0.0F, -6.0F, 0.0F));

        PartDefinition right_volume_fader = middle_fader.addOrReplaceChild("right_volume_fader", CubeListBuilder.create().texOffs(54, 59).addBox(-8.75F, -3.6F, 5.025F, 3.0F, 2.75F, 2.5F, new CubeDeformation(-1.125F)), PartPose.offset(7.5F, 8.0F, -8.0F));

        PartDefinition left_volume_fader = middle_fader.addOrReplaceChild("left_volume_fader", CubeListBuilder.create().texOffs(54, 59).addBox(-9.75F, -3.6F, 5.025F, 3.0F, 2.75F, 2.5F, new CubeDeformation(-1.125F)), PartPose.offset(7.5F, 8.0F, -8.0F));

        PartDefinition mix_fader = middle_fader.addOrReplaceChild("mix_fader", CubeListBuilder.create().texOffs(34, 59).addBox(-1.525F, 4.4F, -5.625F, 2.5F, 2.75F, 3.0F, new CubeDeformation(-1.125F)), PartPose.offset(0.0F, 0.0F, 0.0F));
