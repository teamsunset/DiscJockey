...
public class FileAudioStream implements AudioStream {
    ...
    public ByteBuffer read(int size) {
        ...
        if (this.offset >= 0 && this.offset < this.array.length && this.isPlaying && this.isReversed && offset >= size * speed) {
        ...
        } else if (this.offset >= 0 && this.offset < this.array.length && this.isPlaying && !this.isReversed && array.length >= offset + size * speed) {
            short[] bufferArrayRaw = new short[(int) (size * speed / 2)];
