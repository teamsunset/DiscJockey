...
public class TouchMapDDJ400 extends AbstractTouchMap {
    ...
    public static PlaneRange LEFT_BPM_FADER = new PlaneRange(new Vec2Plane(2.5 / 16D, -4.5 / 16D), new Vec2Plane(3.5 / 16D, -1.5 / 16D));

    public static PlaneRange RIGHT_BPM_FADER = new PlaneRange(new Vec2Plane(-3.5 / 16D, -4.5 / 16D), new Vec2Plane(-2.5 / 16D, -1.5 / 16D));
