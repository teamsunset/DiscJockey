...
public class TouchMapDDJ400 extends AbstractTouchMap {
    ...
    public static PlaneRange RIGHT_CUE_BUTTON = new PlaneRange(new Vec2Plane(-7.5 / 16D, -3.5 / 16D), new Vec2Plane(6.5 / 16D, -2.5 / 16D));
    ...
    public static PlaneRange LEFT_VOLUME_FADER = new PlaneRange(new Vec2Plane(0 / 16D, -3.5 / 16D), new Vec2Plane(1 / 16D, -1.5 / 16D), PlaneRange.RangeReferenceAxis.Z);
    public static PlaneRange RIGHT_VOLUME_FADER = new PlaneRange(new Vec2Plane(-1 / 16D, -3.5 / 16D), new Vec2Plane(0 / 16D, -1.5 / 16D), PlaneRange.RangeReferenceAxis.Z);
}
