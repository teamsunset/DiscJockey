...
public class CreativeModeTabCollection
{
    ...
    public static final RegistryObject<CreativeModeTab> TAB_DISC_JOCKEY = CREATIVE_MODE_TAB_DEFERRED_REGISTER.register(Reference.MOD_ID, () -> CreativeModeTab.builder()
